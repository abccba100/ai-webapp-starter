  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center animate-fade-in-up">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center w-full">
        <Link 
          href="/input" 
          className="bg-blue-600 text-white px-8 py-4 rounded-xl text-lg font-bold hover:bg-blue-700 transition shadow-lg hover:shadow-xl hover:-translate-y-1 text-center"
        >
          무료로 시작하기 🚀
        </Link>
        <button className="bg-white text-gray-700 border border-gray-200 px-8 py-4 rounded-xl text-lg font-medium hover:bg-gray-50 transition shadow-sm text-center">
          데모 영상 보기
        </button>
      </div>
